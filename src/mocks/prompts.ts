...
export const prompts: PromptDTO[] = [
  {
    ...
    description:
      '당신은 전문 블로그 작가입니다. 다음 주제에 대해 SEO 최적화된 블로그 글을 작성해주세요. \n\n주제: [여기에 주제 입력] \n\n요구사항: \n- 2000자 이상 \n- 자연스러운 키워드 배치 \n- 소제목 3개 이상 포함 \n- 독자 친화적인 톤',
    category: '글쓰기',
    tags: 'ChatGPT',
    views: 1200,
  ...
  },
  {
    ...
    description:
      '당신은 시니어 소프트웨어 엔지니어입니다. 다음 코드를 리뷰하고 개선점을 제안해주세요: \n\n[코드 입력] \n\n다음 관점에서 분석해주세요: \n\n1. 코드 품질 및 가독성 \n2. 성능 최적화 가능성 \n3. 보안 취약점 \n4. 베스트 프랙티스 적용 여부 \n5. 구체적인 개선 코드 제시',
    category: '개발',
    tags: 'Claude',
    views: 570,
  ...
  },
  {
    ...
    description:
      '당신은 실리콘밸리 스타트업 멘토입니다. 아래 타깃 고객을 위한 SaaS 아이디어 5가지를 제안해주세요. \n각 아이디어에는 문제 정의, 해결 방법, 수익 모델을 포함해주세요. \n\n타깃: 1인 개발자.',
    category: '기획',
    tags: 'Claude',
    views: 742,
  ...
  },
  {
    ...
    description:
      '당신은 생산성 컨설턴트입니다. 프리랜서 디자이너를 위한 Notion 워크스페이스 구조를 설계해주세요. \n프로젝트, 클라이언트, 인보이스, 개인 할 일 페이지로 구성하고, 각 데이터베이스 필드를 제안해주세요.',
    category: '생산성',
    tags: 'Notion AI',
    views: 389,
  ...
  },
  {
    ...
    description:
      '당신은 유튜브 콘텐츠 크리에이터입니다. 10분 길이의 영상 스크립트를 작성해주세요. \n\n주제: [여기에 주제 입력]. \n\n인트로-본론-마무리 구조를 따르고, 구독과 좋아요를 자연스럽게 유도하는 멘트를 포함해주세요.',
    category: '영상',
    tags: 'ChatGPT',
    views: 3105,
